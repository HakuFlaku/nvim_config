...
vim.keymap.set("n", "<leader>dst", function() dap.terminate() dapui.close() end, { desc = "DAP: end the current debug session" })
vim.keymap.set("n", "<leader>dss", dap.continue, { desc = "DAP: start or continue debug session" })
vim.keymap.set("n", "<leader>dsl", dap.run_last, { desc = "DAP: start debug session with last config" })
vim.keymap.set("n", "<leader>so", dap.step_over, { desc = "DAP: step over" })
vim.keymap.set("n", "<leader>si", dap.step_into, { desc = "DAP: step into" })
vim.keymap.set("n", "<leader>st", dap.step_out, { desc = "DAP: step out" })
...
vim.keymap.set('n', '<leader>to', neotest.output.open, { desc = "Neotest: open output of test" })
